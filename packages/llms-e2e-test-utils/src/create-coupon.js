 ...
 *     Creation arguments.
 *
 *     @type {String} code     Coupon code (post title).
 *     @type {String} discount The discount amount with either a leading `$` to specify dollar amount discounts or a trailing `%` for percentage discounts.
 * }
