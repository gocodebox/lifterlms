...
Options:
  ...
  -L, --links               Add GitHub links to templates and issues in changelog entries. (default: true)
...
Options:
  -a, --archive <zip>               If specified, the zip file will be committed and force-pushed to the specified branch before creating the release. Pass --no-archive to skip this step. (default: "lifterlms-5.5.0.zip")
