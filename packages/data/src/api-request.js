 ...
 * @param {Object} ..fetchArgs    Arguments passed to `@wordpress/api-fetch`, {@link https://github.com/WordPress/gutenberg/tree/trunk/packages/api-fetch#options}.
 * @return {Object} API Response object.
 */
export default function( { namespace = 'llms/v1', resource, path = '', query = {}, ...fetchArgs } ) {

	if ( ! query.context ) {
		query.context = 'edit';
	}
	fetchArgs.path = addQueryArgs( untrailingSlashIt( `${ namespace }/${ resource }/${ path }` ), query );
