...
class LLMS_Blocks_Assets {
	 ...
	 * @since 5.0.0-rc.1 Maybe define backwards compatibility script.
	 *
	 * @return void
	 */
	 ...
	 * @since 5.0.0-rc.1 Maybe load backwards compatibility script.
	 *
	 * @return void
	 */
	...
	private function use_bc_assets() {
		global $wp_version;
		return ( version_compare( $wp_version, LLMS_Forms::instance()::MIN_WP_VERSION, '<' ) &&
			/**
