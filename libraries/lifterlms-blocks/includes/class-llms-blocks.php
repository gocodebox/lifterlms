...
class LLMS_Blocks {
	 ...
	 * @since 5.0.0-rc.2 Move action & filter hooks to the the `init()` method.
	 */
	 ...
	 *
	 * @since 1.5.1
	 * @since 5.0.0-rc.2 Since WordPress 5.8 blocks are available in widgets and customizer screen too.
	 *
	 * @return void
	 */
	 ...
	 * @since 5.0.0-rc.2 Return early if LifterLMS isn't installed, move file inclusion to `$this->includes()`,
