...
[\--all]
: If set, all of the add-ons available to the site will be installed. All existing license keys stored on the site will be queried for the list of available add-ons.
