...
class LLMS_REST_Webhooks extends LLMS_REST_Database_Resource {
	...
	public function get_topics() {
		...
		return apply_filters(
			...
			array(
				...
				'quiz-attempt.completed'      => __( 'Quiz Attempt completed', 'lifterlms' ),
				'quiz-attempt.graded'         => __( 'Quiz Attempt graded', 'lifterlms' ),
				'awarded-certificate.created' => __( 'Awarded Certificate created', 'lifterlms' ),
	...
	public function get_hooks() {
		...
		$hooks = array(
			...
			// Quiz Attempts.
			'quiz-attempt.completed' => array(
				'lifterlms_quiz_completed' => 3,
			),
			'quiz-attempt.graded' => array(
				'llms_quiz_graded' => 3,
			),

			// Awarded Certificates.
			'awarded-certificate.created' => array(
				'llms_user_earned_certificate' => 2,
			),
