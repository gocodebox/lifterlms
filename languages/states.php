...
return array(
	...
	'CC' => array(),
	'CD' => array(
		'BU' => __( 'Bas-Uélé', 'lifterlms' ),
		'HK' => __( 'Haut-Katanga', 'lifterlms' ),
		'HL' => __( 'Haut-Lomami', 'lifterlms' ),
		'HU' => __( 'Haut-Uélé', 'lifterlms' ),
		'IT' => __( 'Ituri', 'lifterlms' ),
		'KS' => __( 'Kasaï', 'lifterlms' ),
		'KC' => __( 'Kasaï Central', 'lifterlms' ),
	...
	'CL' => array(
		...
		'AP' => __( 'Arica y Parinacota', 'lifterlms' ),
		'AT' => __( 'Atacama', 'lifterlms' ),
		'BI' => __( 'Biobío', 'lifterlms' ),
		'CO' => __( 'Coquimbo', 'lifterlms' ),
		'AR' => __( 'La Araucanía', 'lifterlms' ),
		'LI' => __( 'Libertador General Bernardo O\'Higgins', 'lifterlms' ),
		'LL' => __( 'Los Lagos', 'lifterlms' ),
		'LR' => __( 'Los Ríos', 'lifterlms' ),
		'MA' => __( 'Magallanes y de la Antártica Chilena', 'lifterlms' ),
		'ML' => __( 'Maule', 'lifterlms' ),
		'RM' => __( 'Región Metropolitana de Santiago', 'lifterlms' ),
	...
	'CO' => array(
		...
		'ARA' => __( 'Arauca', 'lifterlms' ),
		'ATL' => __( 'Atlántico', 'lifterlms' ),
		'DC'  => __( 'Bogotá', 'lifterlms' ),
		'BOL' => __( 'Bolívar', 'lifterlms' ),
		'BOY' => __( 'Boyacá', 'lifterlms' ),
		'CAL' => __( 'Caldas', 'lifterlms' ),
		'CAQ' => __( 'Caquetá', 'lifterlms' ),
		'CAS' => __( 'Casanare', 'lifterlms' ),
		'CAU' => __( 'Cauca', 'lifterlms' ),
		'CES' => __( 'Cesar', 'lifterlms' ),
		'CHO' => __( 'Chocó', 'lifterlms' ),
		'CUN' => __( 'Cundinamarca', 'lifterlms' ),
		'COR' => __( 'Córdoba', 'lifterlms' ),
		'GUA' => __( 'Guainía', 'lifterlms' ),
		'GUV' => __( 'Guaviare', 'lifterlms' ),
		'HUI' => __( 'Huila', 'lifterlms' ),
		'LAG' => __( 'La Guajira', 'lifterlms' ),
		'MAG' => __( 'Magdalena', 'lifterlms' ),
		'MET' => __( 'Meta', 'lifterlms' ),
		'NAR' => __( 'Nariño', 'lifterlms' ),
		'NSA' => __( 'Norte de Santander', 'lifterlms' ),
		'PUT' => __( 'Putumayo', 'lifterlms' ),
		'QUI' => __( 'Quindío', 'lifterlms' ),
		'RIS' => __( 'Risaralda', 'lifterlms' ),
		'SAP' => __( 'San Andrés, Providencia y Santa Catalina', 'lifterlms' ),
		'SAN' => __( 'Santander', 'lifterlms' ),
		'SUC' => __( 'Sucre', 'lifterlms' ),
		'TOL' => __( 'Tolima', 'lifterlms' ),
		'VAC' => __( 'Valle del Cauca', 'lifterlms' ),
		'VAU' => __( 'Vaupés', 'lifterlms' ),
		'VID' => __( 'Vichada', 'lifterlms' ),
	),
	'CR' => array(
	...
	'CZ' => array(
		'10'  => __( 'Praha, Hlavní město', 'lifterlms' ),
		'20'  => __( 'Středočeský kraj', 'lifterlms' ),
		...
		'64'  => __( 'Jihomoravský kraj', 'lifterlms' ),
		'71'  => __( 'Olomoucký kraj', 'lifterlms' ),
		'72'  => __( 'Zlínský kraj', 'lifterlms' ),
		'80'  => __( 'Moravskoslezský kraj', 'lifterlms' ),
		'201' => __( 'Benešov', 'lifterlms' ),
		'202' => __( 'Beroun', 'lifterlms' ),
		'203' => __( 'Kladno', 'lifterlms' ),
		'204' => __( 'Kolín', 'lifterlms' ),
		'205' => __( 'Kutná Hora', 'lifterlms' ),
		'206' => __( 'Mělník', 'lifterlms' ),
		'207' => __( 'Mladá Boleslav', 'lifterlms' ),
		'208' => __( 'Nymburk', 'lifterlms' ),
		'209' => __( 'Praha-východ', 'lifterlms' ),
		'311' => __( 'České Budějovice', 'lifterlms' ),
		'312' => __( 'Český Krumlov', 'lifterlms' ),
		'313' => __( 'Jindřichův Hradec', 'lifterlms' ),
		'314' => __( 'Písek', 'lifterlms' ),
		'315' => __( 'Prachatice', 'lifterlms' ),
		'316' => __( 'Strakonice', 'lifterlms' ),
		'317' => __( 'Tábor', 'lifterlms' ),
		'321' => __( 'Domažlice', 'lifterlms' ),
		'322' => __( 'Klatovy', 'lifterlms' ),
		'323' => __( 'Plzeň-město', 'lifterlms' ),
		'324' => __( 'Plzeň-jih', 'lifterlms' ),
		'325' => __( 'Plzeň-sever', 'lifterlms' ),
		'326' => __( 'Rokycany', 'lifterlms' ),
		'327' => __( 'Tachov', 'lifterlms' ),
		'411' => __( 'Cheb', 'lifterlms' ),
		'412' => __( 'Karlovy Vary', 'lifterlms' ),
		'413' => __( 'Sokolov', 'lifterlms' ),
		'421' => __( 'Děčín', 'lifterlms' ),
		'422' => __( 'Chomutov', 'lifterlms' ),
		'423' => __( 'Litoměřice', 'lifterlms' ),
		'424' => __( 'Louny', 'lifterlms' ),
		'425' => __( 'Most', 'lifterlms' ),
		'426' => __( 'Teplice', 'lifterlms' ),
		'427' => __( 'Ústí nad Labem', 'lifterlms' ),
		'511' => __( 'Česká Lípa', 'lifterlms' ),
		'512' => __( 'Jablonec nad Nisou', 'lifterlms' ),
		'513' => __( 'Liberec', 'lifterlms' ),
		'514' => __( 'Semily', 'lifterlms' ),
		'521' => __( 'Hradec Králové', 'lifterlms' ),
		'522' => __( 'Jičín', 'lifterlms' ),
		'523' => __( 'Náchod', 'lifterlms' ),
		'524' => __( 'Rychnov nad Kněžnou', 'lifterlms' ),
		'525' => __( 'Trutnov', 'lifterlms' ),
		'531' => __( 'Chrudim', 'lifterlms' ),
		'532' => __( 'Pardubice', 'lifterlms' ),
		'533' => __( 'Svitavy', 'lifterlms' ),
		'534' => __( 'Ústí nad Orlicí', 'lifterlms' ),
		'631' => __( 'Havlíčkův Brod', 'lifterlms' ),
		'632' => __( 'Jihlava', 'lifterlms' ),
		'633' => __( 'Pelhřimov', 'lifterlms' ),
		'634' => __( 'Třebíč', 'lifterlms' ),
		'635' => __( 'Žďár nad Sázavou', 'lifterlms' ),
		'641' => __( 'Blansko', 'lifterlms' ),
		'642' => __( 'Brno-město', 'lifterlms' ),
		'643' => __( 'Brno-venkov', 'lifterlms' ),
		'644' => __( 'Břeclav', 'lifterlms' ),
		'645' => __( 'Hodonín', 'lifterlms' ),
		'646' => __( 'Vyškov', 'lifterlms' ),
		'647' => __( 'Znojmo', 'lifterlms' ),
		'711' => __( 'Jeseník', 'lifterlms' ),
		'712' => __( 'Olomouc', 'lifterlms' ),
		'713' => __( 'Prostějov', 'lifterlms' ),
		'714' => __( 'Přerov', 'lifterlms' ),
		'715' => __( 'Šumperk', 'lifterlms' ),
		'721' => __( 'Kroměříž', 'lifterlms' ),
		'722' => __( 'Uherské Hradiště', 'lifterlms' ),
		'723' => __( 'Vsetín', 'lifterlms' ),
		'724' => __( 'Zlín', 'lifterlms' ),
		'801' => __( 'Bruntál', 'lifterlms' ),
		'802' => __( 'Frýdek-Místek', 'lifterlms' ),
		'803' => __( 'Karviná', 'lifterlms' ),
		'804' => __( 'Nový Jičín', 'lifterlms' ),
		'805' => __( 'Opava', 'lifterlms' ),
		'806' => __( 'Ostrava-město', 'lifterlms' ),
		'20A' => __( 'Praha-západ', 'lifterlms' ),
		'20B' => __( 'Příbram', 'lifterlms' ),
		'20C' => __( 'Rakovník', 'lifterlms' ),
	),
	'DE' => array(
	...
	'JP' => array(
		...
		'39' => __( 'Kōchi Prefecture', 'lifterlms' ),
	...
	'MA' => array(
		'10'  => __( 'Guelmim-Oued Noun (EH-partial)', 'lifterlms' ),
		'11'  => __( 'Laâyoune-Sakia El Hamra (EH-partial)', 'lifterlms' ),
		'12'  => __( 'Dakhla-Oued Ed-Dahab (EH)', 'lifterlms' ),
		'AGD' => __( 'Agadir-Ida-Ou-Tanane', 'lifterlms' ),
		'HAO' => __( 'Al Haouz', 'lifterlms' ),
		'HOC' => __( 'Al Hoceïma', 'lifterlms' ),
		'AOU' => __( 'Aousserd (EH)', 'lifterlms' ),
		'ASZ' => __( 'Assa-Zag (EH-partial)', 'lifterlms' ),
		'AZI' => __( 'Azilal', 'lifterlms' ),
		'BES' => __( 'Benslimane', 'lifterlms' ),
		'BER' => __( 'Berkane', 'lifterlms' ),
		'BRR' => __( 'Berrechid', 'lifterlms' ),
		'BOD' => __( 'Boujdour (EH)', 'lifterlms' ),
		'BOM' => __( 'Boulemane', 'lifterlms' ),
		'BEM' => __( 'Béni Mellal', 'lifterlms' ),
		'05'  => __( 'Béni Mellal-Khénifra', 'lifterlms' ),
		'CAS' => __( 'Casablanca', 'lifterlms' ),
		'06'  => __( 'Casablanca-Settat', 'lifterlms' ),
		'CHE' => __( 'Chefchaouen', 'lifterlms' ),
		'CHI' => __( 'Chichaoua', 'lifterlms' ),
		'CHT' => __( 'Chtouka-Ait Baha', 'lifterlms' ),
		'DRI' => __( 'Driouch', 'lifterlms' ),
		'08'  => __( 'Drâa-Tafilalet', 'lifterlms' ),
		'HAJ' => __( 'El Hajeb', 'lifterlms' ),
		'JDI' => __( 'El Jadida', 'lifterlms' ),
		'KES' => __( 'El Kelâa des Sraghna', 'lifterlms' ),
		'ERR' => __( 'Errachidia', 'lifterlms' ),
		'ESM' => __( 'Es-Semara (EH-partial)', 'lifterlms' ),
		'ESI' => __( 'Essaouira', 'lifterlms' ),
		'FAH' => __( 'Fahs-Anjra', 'lifterlms' ),
		'FIG' => __( 'Figuig', 'lifterlms' ),
		'FQH' => __( 'Fquih Ben Salah', 'lifterlms' ),
		'FES' => __( 'Fès', 'lifterlms' ),
		'03'  => __( 'Fès-Meknès', 'lifterlms' ),
		'GUE' => __( 'Guelmim', 'lifterlms' ),
		'GUF' => __( 'Guercif', 'lifterlms' ),
		'IFR' => __( 'Ifrane', 'lifterlms' ),
		'INE' => __( 'Inezgane-Ait Melloul', 'lifterlms' ),
		'JRA' => __( 'Jerada', 'lifterlms' ),
		'KHO' => __( 'Khouribga', 'lifterlms' ),
		'KHE' => __( 'Khémisset', 'lifterlms' ),
		'KHN' => __( 'Khénifra', 'lifterlms' ),
		'KEN' => __( 'Kénitra', 'lifterlms' ),
		'02'  => __( 'L\'Oriental', 'lifterlms' ),
		'LAR' => __( 'Larache', 'lifterlms' ),
		'LAA' => __( 'Laâyoune (EH)', 'lifterlms' ),
		'MAR' => __( 'Marrakech', 'lifterlms' ),
		'07'  => __( 'Marrakesh-Safi', 'lifterlms' ),
		'MEK' => __( 'Meknès', 'lifterlms' ),
		'MID' => __( 'Midelt', 'lifterlms' ),
		'MOH' => __( 'Mohammadia', 'lifterlms' ),
		'MOU' => __( 'Moulay Yacoub', 'lifterlms' ),
		'MED' => __( 'Médiouna', 'lifterlms' ),
		'MDF' => __( 'M’diq-Fnideq', 'lifterlms' ),
		'NAD' => __( 'Nador', 'lifterlms' ),
		'NOU' => __( 'Nouaceur', 'lifterlms' ),
		'OUA' => __( 'Ouarzazate', 'lifterlms' ),
		'OUD' => __( 'Oued Ed-Dahab (EH)', 'lifterlms' ),
		'OUZ' => __( 'Ouezzane', 'lifterlms' ),
		'OUJ' => __( 'Oujda-Angad', 'lifterlms' ),
		'RAB' => __( 'Rabat', 'lifterlms' ),
		'04'  => __( 'Rabat-Salé-Kénitra', 'lifterlms' ),
		'REH' => __( 'Rehamna', 'lifterlms' ),
		'SAF' => __( 'Safi', 'lifterlms' ),
		'SAL' => __( 'Salé', 'lifterlms' ),
		'SEF' => __( 'Sefrou', 'lifterlms' ),
		'SET' => __( 'Settat', 'lifterlms' ),
		'SIB' => __( 'Sidi Bennour', 'lifterlms' ),
		'SIF' => __( 'Sidi Ifni', 'lifterlms' ),
		'SIK' => __( 'Sidi Kacem', 'lifterlms' ),
		'SIL' => __( 'Sidi Slimane', 'lifterlms' ),
		'SKH' => __( 'Skhirate-Témara', 'lifterlms' ),
		'09'  => __( 'Souss-Massa', 'lifterlms' ),
		'TNT' => __( 'Tan-Tan (EH-partial)', 'lifterlms' ),
		'TNG' => __( 'Tanger-Assilah', 'lifterlms' ),
		'01'  => __( 'Tanger-Tétouan-Al Hoceïma', 'lifterlms' ),
		'TAO' => __( 'Taounate', 'lifterlms' ),
		'TAI' => __( 'Taourirt', 'lifterlms' ),
		'TAF' => __( 'Tarfaya (EH-partial)', 'lifterlms' ),
		'TAR' => __( 'Taroudannt', 'lifterlms' ),
		'TAT' => __( 'Tata', 'lifterlms' ),
		'TAZ' => __( 'Taza', 'lifterlms' ),
		'TIN' => __( 'Tinghir', 'lifterlms' ),
		'TIZ' => __( 'Tiznit', 'lifterlms' ),
		'TET' => __( 'Tétouan', 'lifterlms' ),
		'YUS' => __( 'Youssoufia', 'lifterlms' ),
		'ZAG' => __( 'Zagora', 'lifterlms' ),
	),
	'MC' => array(
	...
	'NG' => array(
		...
		'FC' => __( 'Abuja Federal Capital Territory', 'lifterlms' ),
		'AD' => __( 'Adamawa', 'lifterlms' ),
	...
	'VN' => array(
		...
		'CT' => __( 'Cần Thơ', 'lifterlms' ),
		'03' => __( 'Hà Giang', 'lifterlms' ),
		'HN' => __( 'Hà Nội', 'lifterlms' ),
		'HP' => __( 'Hải Phòng', 'lifterlms' ),
		'SG' => __( 'Hồ Chí Minh', 'lifterlms' ),
