...
return array(
	...
	'DZ' => array(
		'10' => __( 'Bouïra Province', 'lifterlms' ),
		'11' => __( 'Tamanghasset Province', 'lifterlms' ),
		'12' => __( 'Tébessa Province', 'lifterlms' ),
		'13' => __( 'Tlemcen Province', 'lifterlms' ),
		'14' => __( 'Tiaret Province', 'lifterlms' ),
		'15' => __( 'Tizi Ouzou Province', 'lifterlms' ),
		'16' => __( 'Algiers Province', 'lifterlms' ),
		'17' => __( 'Djelfa Province', 'lifterlms' ),
		'18' => __( 'Jijel Province', 'lifterlms' ),
		'19' => __( 'Sétif Province', 'lifterlms' ),
		'20' => __( 'Saïda Province', 'lifterlms' ),
		'21' => __( 'Skikda Province', 'lifterlms' ),
		'23' => __( 'Annaba Province', 'lifterlms' ),
		'24' => __( 'Guelma Province', 'lifterlms' ),
		'25' => __( 'Constantine Province', 'lifterlms' ),
		'26' => __( 'Médéa Province', 'lifterlms' ),
		'27' => __( 'Mostaganem Province', 'lifterlms' ),
		'28' => __( 'M\'Sila Province', 'lifterlms' ),
		'29' => __( 'Mascara Province', 'lifterlms' ),
		'30' => __( 'Ouargla Province', 'lifterlms' ),
		'31' => __( 'Oran Province', 'lifterlms' ),
		'32' => __( 'El Bayadh Province', 'lifterlms' ),
		'33' => __( 'Illizi Province', 'lifterlms' ),
		'34' => __( 'Bordj Bou Arréridj Province', 'lifterlms' ),
		'35' => __( 'Boumerdès Province', 'lifterlms' ),
		'36' => __( 'El Tarf Province', 'lifterlms' ),
		'37' => __( 'Tindouf Province', 'lifterlms' ),
		'38' => __( 'Tissemsilt Province', 'lifterlms' ),
		'39' => __( 'El Oued Province', 'lifterlms' ),
		'40' => __( 'Khenchela Province', 'lifterlms' ),
		'41' => __( 'Souk Ahras Province', 'lifterlms' ),
		'42' => __( 'Tipasa Province', 'lifterlms' ),
		'43' => __( 'Mila Province', 'lifterlms' ),
		'44' => __( 'Aïn Defla Province', 'lifterlms' ),
		'45' => __( 'Naama Province', 'lifterlms' ),
		'46' => __( 'Aïn Témouchent Province', 'lifterlms' ),
		'47' => __( 'Ghardaïa Province', 'lifterlms' ),
		'48' => __( 'Relizane Province', 'lifterlms' ),
		'01' => __( 'Adrar Province', 'lifterlms' ),
		'05' => __( 'Batna Province', 'lifterlms' ),
		'07' => __( 'Biskra', 'lifterlms' ),
		'09' => __( 'Blida Province', 'lifterlms' ),
		'08' => __( 'Béchar Province', 'lifterlms' ),
		'06' => __( 'Béjaïa Province', 'lifterlms' ),
		'02' => __( 'Chlef Province', 'lifterlms' ),
		'03' => __( 'Laghouat Province', 'lifterlms' ),
		'04' => __( 'Oum El Bouaghi Province', 'lifterlms' ),
	),
	'EC' => array(
	...
	'ES' => array(
		'C'  => __( 'A Coruña Province', 'lifterlms' ),
		'AB' => __( 'Albacete Province', 'lifterlms' ),
		'A'  => __( 'Alicante Province', 'lifterlms' ),
		'AL' => __( 'Almería Province', 'lifterlms' ),
		'AN' => __( 'Andalusia', 'lifterlms' ),
		'VI' => __( 'Araba / Álava', 'lifterlms' ),
		'AR' => __( 'Aragon', 'lifterlms' ),
		'BA' => __( 'Badajoz Province', 'lifterlms' ),
		'PM' => __( 'Balearic Islands', 'lifterlms' ),
		'B'  => __( 'Barcelona Province', 'lifterlms' ),
		...
		'CS' => __( 'Castellón Province', 'lifterlms' ),
		'CL' => __( 'Castile and León', 'lifterlms' ),
		'CM' => __( 'Castile-La Mancha', 'lifterlms' ),
		'CT' => __( 'Catalonia', 'lifterlms' ),
		'CE' => __( 'Ceuta', 'lifterlms' ),
		'CR' => __( 'Ciudad Real Province', 'lifterlms' ),
		'MD' => __( 'Community of Madrid', 'lifterlms' ),
		'CU' => __( 'Cuenca Province', 'lifterlms' ),
		'CC' => __( 'Cáceres Province', 'lifterlms' ),
		'CA' => __( 'Cádiz Province', 'lifterlms' ),
		'CO' => __( 'Córdoba Province', 'lifterlms' ),
		'EX' => __( 'Extremadura', 'lifterlms' ),
		'GA' => __( 'Galicia', 'lifterlms' ),
		'SS' => __( 'Gipuzkoa', 'lifterlms' ),
		'GI' => __( 'Girona Province', 'lifterlms' ),
		'GR' => __( 'Granada Province', 'lifterlms' ),
		'GU' => __( 'Guadalajara Province', 'lifterlms' ),
		'H'  => __( 'Huelva Province', 'lifterlms' ),
		'HU' => __( 'Huesca Province', 'lifterlms' ),
		'J'  => __( 'Jaén Province', 'lifterlms' ),
		'RI' => __( 'La Rioja', 'lifterlms' ),
		'GC' => __( 'Las Palmas Province', 'lifterlms' ),
		'LE' => __( 'León Province', 'lifterlms' ),
		'L'  => __( 'Lleida Province', 'lifterlms' ),
		'LU' => __( 'Lugo Province', 'lifterlms' ),
		'M'  => __( 'Madrid Province', 'lifterlms' ),
		'ML' => __( 'Melilla', 'lifterlms' ),
		'MU' => __( 'Murcia Province', 'lifterlms' ),
		'MA' => __( 'Málaga Province', 'lifterlms' ),
		'NC' => __( 'Navarre', 'lifterlms' ),
		'OR' => __( 'Ourense Province', 'lifterlms' ),
		'P'  => __( 'Palencia Province', 'lifterlms' ),
		'PO' => __( 'Pontevedra Province', 'lifterlms' ),
		'O'  => __( 'Province of Asturias', 'lifterlms' ),
		'AV' => __( 'Province of Ávila', 'lifterlms' ),
		'MC' => __( 'Region of Murcia', 'lifterlms' ),
		'SA' => __( 'Salamanca Province', 'lifterlms' ),
		'TF' => __( 'Santa Cruz de Tenerife Province', 'lifterlms' ),
		'SG' => __( 'Segovia Province', 'lifterlms' ),
		'SE' => __( 'Seville Province', 'lifterlms' ),
		'SO' => __( 'Soria Province', 'lifterlms' ),
		'T'  => __( 'Tarragona Province', 'lifterlms' ),
		'TE' => __( 'Teruel Province', 'lifterlms' ),
		'TO' => __( 'Toledo Province', 'lifterlms' ),
		'V'  => __( 'Valencia Province', 'lifterlms' ),
		'VC' => __( 'Valencian Community', 'lifterlms' ),
		'VA' => __( 'Valladolid Province', 'lifterlms' ),
		'ZA' => __( 'Zamora Province', 'lifterlms' ),
		'Z'  => __( 'Zaragoza Province', 'lifterlms' ),
	),
	'ET' => array(
	...
	'IR' => array(
		'10' => __( 'Khuzestan Province', 'lifterlms' ),
		'11' => __( 'Zanjan Province', 'lifterlms' ),
		'12' => __( 'Semnan Province', 'lifterlms' ),
		'13' => __( 'Sistan and Baluchestan', 'lifterlms' ),
		'14' => __( 'Fars Province', 'lifterlms' ),
		'15' => __( 'Kerman Province', 'lifterlms' ),
		'16' => __( 'Kurdistan Province', 'lifterlms' ),
		'17' => __( 'Kermanshah Province', 'lifterlms' ),
		'18' => __( 'Kohgiluyeh and Boyer-Ahmad Province', 'lifterlms' ),
		'19' => __( 'Gilan Province', 'lifterlms' ),
		'20' => __( 'Lorestan Province', 'lifterlms' ),
		'21' => __( 'Mazandaran Province', 'lifterlms' ),
		'22' => __( 'Markazi Province', 'lifterlms' ),
		'23' => __( 'Hormozgan Province', 'lifterlms' ),
		'25' => __( 'Yazd Province', 'lifterlms' ),
		'26' => __( 'Qom Province', 'lifterlms' ),
		'27' => __( 'Golestan Province', 'lifterlms' ),
		'28' => __( 'Qazvin Province', 'lifterlms' ),
		'29' => __( 'South Khorasan Province', 'lifterlms' ),
		'30' => __( 'Razavi Khorasan Province', 'lifterlms' ),
		'31' => __( 'North Khorasan Province', 'lifterlms' ),
		'32' => __( 'Alborz Province', 'lifterlms' ),
		'03' => __( 'Ardabil Province', 'lifterlms' ),
		'06' => __( 'Bushehr Province', 'lifterlms' ),
		'08' => __( 'Chaharmahal and Bakhtiari Province', 'lifterlms' ),
		'01' => __( 'East Azerbaijan Province', 'lifterlms' ),
		'05' => __( 'Ilam Province', 'lifterlms' ),
		'04' => __( 'Isfahan Province', 'lifterlms' ),
		'07' => __( 'Tehran Province', 'lifterlms' ),
		'02' => __( 'West Azarbaijan Province', 'lifterlms' ),
	),
	'IS' => array(
	...
	'PS' => array(),
	'PT' => array(
		'10' => __( 'Leiria District', 'lifterlms' ),
		'11' => __( 'Lisbon District', 'lifterlms' ),
		'12' => __( 'Portalegre District', 'lifterlms' ),
		'13' => __( 'Porto District', 'lifterlms' ),
		'14' => __( 'Santarém District', 'lifterlms' ),
		'15' => __( 'Setúbal District', 'lifterlms' ),
		'16' => __( 'Viana do Castelo District', 'lifterlms' ),
		'17' => __( 'Vila Real District', 'lifterlms' ),
		'18' => __( 'Viseu District', 'lifterlms' ),
		'20' => __( 'Azores', 'lifterlms' ),
		'30' => __( 'Madeira', 'lifterlms' ),
		'01' => __( 'Aveiro District', 'lifterlms' ),
		'02' => __( 'Beja District', 'lifterlms' ),
		'03' => __( 'Braga District', 'lifterlms' ),
		'04' => __( 'Bragança District', 'lifterlms' ),
		'05' => __( 'Castelo Branco District', 'lifterlms' ),
		'06' => __( 'Coimbra District', 'lifterlms' ),
		'08' => __( 'Faro District', 'lifterlms' ),
		'09' => __( 'Guarda District', 'lifterlms' ),
		'07' => __( 'Évora District', 'lifterlms' ),
	),
	'PW' => array(
