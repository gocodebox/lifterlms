 ...
 * @since [version] Include Akismet integration class.
 */
final class LifterLMS {
	 ...
	 * @var string
	 */
	public $version = '3.37.12-alpha.1';
	...
	private function includes() {
		...
		require_once 'includes/integrations/class-llms-integration-akismet.php';
