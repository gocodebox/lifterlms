...
`;function u(t){if((t="string"==typeof t?document.querySelectorAll(t):t)instanceof NodeList)return Array.from(t);let e=[];return t instanceof Element?e.push(t):"undefined"!=typeof jQuery&&t instanceof jQuery&&t.toArray().forEach(t=>e.push(t)),e}function o(t,e=c,n=!0){l="llms-spinner-styles",document.getElementById(l)||((i=document.createElement("style")).textContent=h.replace(/\n/g,"").replace(/\t/g," ").replace(/\s\s+/g," "),i.id=l,document.head.appendChild(i));var i,s,o,l=u(t);return l.length?(t=((t=(o=i=l[0]).querySelectorAll("."+a)).length?Array.from(t).find(t=>o===t.parentNode):null)||([l,t=c]=[i,e],e=document.createElement("div"),s=(0,d.__)("Loading…","lifterlms"),e.innerHTML=`<i class="${r} ${t}" role="alert" aria-live="assertive"><span class="screen-reader-text">${s}</span></i>`,e.classList.add(a),l.appendChild(e),e),n&&"undefined"!=typeof jQuery?jQuery(t):t):null}window.LLMS=window.LLMS||{},window.LLMS.Spinner=s}LLMS.init=function(){for(var t in LLMS)"object"==typeof LLMS[t]&&null!==LLMS[t]&&void 0!==LLMS[t].init&&"function"==typeof LLMS[t].init&&LLMS[t].init()},LLMS.is_touch_device=function(){var t=" -webkit- -moz- -o- -ms- ".split(" ");return!!("ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch)||(t=["(",t.join("touch-enabled),("),"heartz",")"].join(""),window.matchMedia(t).matches)},LLMS.wait_for_matchHeight=function(t){this.wait_for(function(){return void 0!==l.fn.matchHeight},t,"matchHeight")},LLMS.wait_for_popover=function(t){this.wait_for(function(){return void 0!==l.fn.webuiPopover},t,"webuiPopover")},LLMS.wait_for=function(t,e,n){var i,s=0;n=n||"unnamed",i=setInterval(function(){if(300<=s)console.log("Unable to load dependency: "+n);else{if(!t())return void s++;e()}clearInterval(i)},100)},LLMS.init(l)})(jQuery);
