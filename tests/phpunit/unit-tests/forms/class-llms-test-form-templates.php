...
class LLMS_Test_Form_Templates extends LLMS_Unit_Test_Case {
	...
	public function assertReusableBlockContentMatchesSnapshot( $id, $actual ) {
		...
		$snapshots = array(
			...
			'phone'        => '<!-- wp:llms/form-field-user-phone {"field":"tel","label":"Phone Number","name":"llms_phone","id":"llms_phone","data_store":"usermeta","data_store_key":"llms_phone"} /-->',
		);
