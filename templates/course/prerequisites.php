...
if ( ! $course->has_prerequisite() ) { return; }
?>

<?php if ( ! $course->is_prerequisite_complete( 'course' ) ) : $prereq_id = $course->get_prerequisite_id( 'course' ); ?>
...
<?php if ( ! $course->is_prerequisite_complete( 'track' ) ) : $track = new LLMS_Track( $course->get_prerequisite_id( 'track' ) ); ?>
