			...
			<div class="llms-lesson-preview">
				<a class="llms-lesson-link" href="<?php echo esc_url( get_permalink( $lesson->get( 'parent_course' ) ) ); ?>">
					<section class="llms-main">
						<h6 class="llms-pre-text"><?php echo esc_html__( 'Back to Course', 'lifterlms' ); ?></h6>
						<h5 class="llms-h5 llms-lesson-title"><?php echo esc_html( get_the_title( $lesson->get( 'parent_course' ) ) ); ?></h5>
					</section>
				</a>
			</div>
		</div>
