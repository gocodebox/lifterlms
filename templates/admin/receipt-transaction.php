<?php
/**
 * Single Transaction Receipt Template (HTML, printable)
 *
...
<head>
	...
	<?php
		...
		printf( esc_html__( 'Receipt - Transaction #%d', 'lifterlms' ), $transaction->get( 'id' ) );
	?>
	</title>
	<style>
...
<body>
	<div class="receipt-header">
		<div>
			...
			<?php
				/* translators: %d: Transaction ID */
				printf( esc_html__( 'Transaction Receipt #%d', 'lifterlms' ), $transaction->get( 'id' ) );
			?>
			</h1>
	...
	<table>
		<tbody>
			...
			<?php if ( $transaction->get( 'gateway_transaction_id' ) ) : ?>
			<tr>
				<th><?php esc_html_e( 'Gateway Transaction ID', 'lifterlms' ); ?></th>
				<td><?php echo esc_html( $transaction->get( 'gateway_transaction_id' ) ); ?></td>
			</tr>
			<?php endif; ?>
		</tbody>
	</table>
