 ...
 */
$display_free_enroll_form = ! is_singular( 'course' ) && get_current_user_id() && $plan->has_free_checkout() && $plan->is_available_to_user();

if ( apply_filters( 'llms_display_free_enroll_form', $display_free_enroll_form, $plan ) ) :
	?>
