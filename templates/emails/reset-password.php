...
<p><?php _e( 'Someone requested that the password be reset for the following account:', 'lifterlms' ); ?></p>
<p><?php printf( __( 'Username: %s', 'lifterlms' ), $user_login ); ?></p>
<p><?php _e( 'If this was a mistake, just ignore this email and nothing will happen.', 'lifterlms' ); ?></p>
<p><?php _e( 'To reset your password, visit the following address:', 'lifterlms' ); ?></p>
<p>
