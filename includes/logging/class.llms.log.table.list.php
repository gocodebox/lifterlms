...
class LLMS_Log_Table_List extends WP_List_Table {
	...
	public function level_dropdown() {
		...
		$levels = array(
			array( 'value' => 'error',     'label' => __( 'Error',     'lifterlms' ) ),
			array( 'value' => 'warning',   'label' => __( 'Warning',   'lifterlms' ) ),
			array( 'value' => 'notice',    'label' => __( 'Notice',    'lifterlms' ) ),
			array( 'value' => 'info',      'label' => __( 'Info',      'lifterlms' ) )
		);
