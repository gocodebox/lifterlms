...
function llms_get_engagement_triggers() {
	...
	return apply_filters(
		...
		array(
			...
			'quiz_failed_multiple'            => __( 'Student fails a quiz multiple times', 'lifterlms' ),
			...
			'course_enrollment_cancelled'     => __( "Student's course enrollment is cancelled", 'lifterlms' ),
			'course_enrollment_expired'       => __( "Student's course enrollment expires", 'lifterlms' ),
			'membership_enrollment_cancelled' => __( "Student's membership enrollment is cancelled", 'lifterlms' ),
			'membership_enrollment_expired'   => __( "Student's membership enrollment expires", 'lifterlms' ),
			'order_failed'                    => __( "Student's order fails", 'lifterlms' ),
			'order_refunded'                  => __( "Student's order is refunded", 'lifterlms' ),
			'order_cancelled'                 => __( "Student's order is cancelled", 'lifterlms' ),
			'days_since_login'                => __( 'Student has not logged in for a number of days', 'lifterlms' ),
			'course_inactivity'               => __( 'Student has no progress in a course for a number of days', 'lifterlms' ),
			'course_never_started'            => __( 'Student has not started a course a number of days after enrolling', 'lifterlms' ),
			'course_completion_deadline'      => __( 'Student has not completed a course a number of days after enrolling', 'lifterlms' ),
			'quiz_attempt_abandoned'          => __( 'Student leaves a quiz attempt incomplete for a number of days', 'lifterlms' ),
		)
	);
}
