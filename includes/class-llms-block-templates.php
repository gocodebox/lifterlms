...
class LLMS_Block_Templates {
	...
	private function template_titles() {
		...
		$template_titles = array(
			...
			self::LLMS_BLOCK_TEMPLATES_PREFIX . 'single-lesson-focus'        => esc_html__( 'Single Lesson Focus Mode', 'lifterlms' ),
	...
	private function block_editor_l10n() {
		...
		return array(
			...
			'single-lesson-focus'        => esc_html__( 'LifterLMS Single Lesson Focus Mode Template', 'lifterlms' ),
