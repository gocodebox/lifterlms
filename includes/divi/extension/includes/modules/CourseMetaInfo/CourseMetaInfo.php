...
class LLMS_Divi_Course_Meta_Info extends ET_Builder_Module {

	public $slug       = 'lifterlms_divi_course_meta_info';
	...
	public function init() {
		$this->name      = esc_html__( 'LifterLMS Course Meta Info', 'lifterlms' );
	...
	public function get_fields() {
		return array(
			...
			'__preview_html' => array(
				'type'                => 'computed',
				'computed_callback'   => array( 'LLMS_Divi_Course_Meta_Info', 'get_preview_html' ),
	...
	static function get_preview_html( $args = array(), $conditional_tags = array(), $current_page = array() ) {
		...
		$output = do_shortcode( '[lifterlms_course_meta_info course_id="' . absint( $course_id ) . '"]' );
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		return do_shortcode( '[lifterlms_course_meta_info course_id="' . absint( $course_id ) . '"]' );
	}
}

new LLMS_Divi_Course_Meta_Info();
