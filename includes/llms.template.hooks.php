...
add_action( 'lifterlms_single_course_summary', 'lifterlms_template_single_lesson_length', 30 );
add_action( 'lifterlms_single_course_summary', 'lifterlms_template_single_video', 40 );
