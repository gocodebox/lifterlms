...
add_action( 'lifterlms_single_lesson_before_summary', 'lifterlms_template_favorite', 10 );
...
add_action( 'lifterlms_student_dashboard_index', 'lifterlms_template_student_dashboard_my_favorites', 50 );
