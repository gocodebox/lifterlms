...
add_action( 'lifterlms_single_lesson_summary', 'lifterlms_template_single_video', 10 );
add_action( 'lifterlms_single_lesson_summary', 'lifterlms_template_single_audio', 10 );
