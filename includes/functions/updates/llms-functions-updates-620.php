<?php
/**
 * Update functions for version 6.2.0.
 *
...
namespace LLMS\Updates\Version_6_2_0;

defined( 'ABSPATH' ) || exit;

/**
 * For old users: explicitly limit by default the buddypress profile endpoints to those existing prior to 6.2.0.
 *
 * @since [version]
 *
...
function update_db_version() {
	\LLMS_Install::update_db_version( '6.2.0' );
}
