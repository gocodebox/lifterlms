...
function get_lifterlms_currencies() {
	return array_unique( apply_filters( 'lifterlms_currencies', array(
...
function get_lifterlms_currency_symbol( $currency = '' ) {
	...
	$symbols = apply_filters( 'lifterlms_currency_symbols', array(
		'AED' => '&#x62f;.&#x625;',
		'AFN' => '&#x60b;',
		'ALL' => 'L',
		'AMD' => 'AMD',
...
function llms_price( $price, $args = array() ) {
	...
	extract( apply_filters( 'llms_price_args', array_merge( array(
		'currency' => '',
