...
class LLMS_Twenty_Twenty_One {
	...
	protected static function generate_inline_styles( $context = null ) {
		...
		if ( is_null( $context ) ) {
			...
			// Make sure the checkout and login form and their children's box-sizing is border-box.
			//$styles[] = '.llms-person-login-form-wrapper, llms-person-login-form-wrapper *, .llms-checkout-wrapper, .llms-checkout-wrapper * { box-sizing: border-box }';
