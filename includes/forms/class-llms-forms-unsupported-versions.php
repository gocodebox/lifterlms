...
class LLMS_Forms_Unsupported_Versions {
	...
	public function output_notice() {
		...
		<div class="notice notice-error">
			...
			printf( esc_html__( 'In order to manage LifterLMS Forms you must upgrade to at least WordPress version %s or later or install the latest version of the Gutenberg plugin.', 'lifterlms' ), esc_html( LLMS_Forms::instance()::MIN_WP_VERSION ) );
			?></p>
