 ...
 * @since [version] Removed deprecated `LLMS_Admin_Setup_Wizard::generator_course_status()`, `LLMS_Admin_Setup_Wizard::output_step_html()`,
 *              `LLMS_Admin_Setup_Wizard::scripts()`, and `LLMS_Admin_Setup_Wizard::watch_course_generation()`.
 */
