...
<div class="notice notice-info is-dismissible llms-review-notice">
	...
	<p><?php printf( esc_html__( 'Hey there, I noticed you have more than %s active students on your site - that’s really awesome!', 'lifterlms' ), number_format_i18n( $enrollments ) ); ?></p>
	<p><?php esc_html_e( 'Could you please do me a BIG favor and give LifterLMS a 5-star rating on WordPress to help us spread the word and boost our motivation?', 'lifterlms' ); ?></p>
	<p>&ndash; <?php esc_html_e( 'Chris Badgett, Co-Founder of LifterLMS', 'lifterlms' ); ?></p>
	<p>
