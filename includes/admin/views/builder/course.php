...
<script type="text/html" id="tmpl-llms-course-template">
	...
	<header class="llms-builder-header llms-course-header">
		...
		<h1 class="llms-headline">
			<span class="llms-input llms-editable-title" contenteditable="true" data-original-content="{{{ data.get( 'title' ) }}}" data-attribute="title" data-required="required" type="text">{{{ data.get( 'title' ) }}}</span>
		</h1>
