...
<div class="wrap lifterlms lifterlms-settings llms-resources">
	...
	<div class="llms-inside-wrap">
		<div class="llms-helper-blocks">
    		...
    		<p>Thank you for choosing LifterLMS! This page will be your help command center, where you can find all of the basic information you will need to get started building your courses, and fast travel to any further documentation or support you may need along the way.</p></center>
    	</div>
    	<div class="llms-helper-resources-style2">
			...
			<div class="llms-helper-blocks">
				<div class="llms-list">
					<h3><?php esc_html_e( 'Getting Started with LifterLMS', 'lifterlms' ); ?></h3>
					<ul>
						...
						<li><a href="" target="_blank" rel="noopener"><?php esc_html_e( 'How to Edit a Lesson', 'lifterlms' ); ?></a></li>
					...
					<br><a class="llms-button-primary" href="https://lifterlms.com/start-in-style/?utm_source=LifterLMS%20Plugin&utm_medium=Resource%20Screen&utm_campaign=Backend%20Help%20Page">All Getting Started Resources</a>
				</div>
			</div>
		</div>
		<div class="llms-helper-blocks">
			<div class="llms-helper-resources">
				<div class="llms-list">
					<h3><?php esc_html_e( 'Key Documentation', 'lifterlms' ); ?></h3>
					<ul>
					...
					<br><a class="llms-button-primary" href="https://lifterlms.com/docs/?utm_source=LifterLMS%20Plugin&utm_medium=Resource%20Screen&utm_campaign=Backend%20Help%20Page">Knowledge Base</a>
				</div>	
				<div class="llms-list">
					<h3><?php esc_html_e( 'Developer Documentation', 'lifterlms' ); ?></h3>
					<ul>
					...
					<br><a class="llms-button-secondary" href="https://developer.lifterlms.com/?utm_source=LifterLMS%20Plugin&utm_medium=Resource%20Screen&utm_campaign=Backend%20Help%20Page">Developer Base</a> 
				</div>
				<div class="llms-list">
					<h3><?php esc_html_e( 'Common Hang-ups', 'lifterlms' ); ?></h3>
					<ul>
					...
					<br><a class="llms-button-action" href="https://lifterlms.com/my-account/my-tickets/new/?utm_source=LifterLMS%20Plugin&utm_medium=Resource%20Screen&utm_campaign=Backend%20Help%20Page">Contact Support</a>
				</div>	
			</div>
			<hr />
			<div class="llms-helper-resources">
				<div class="llms-list">
					<h3><?php esc_html_e( 'Courses and Case Studies', 'lifterlms' ); ?></h3>
					<ul>
						...
						<li><a href="https://wp101.com/course/wordpress101/?utm_source=LifterLMS%20Plugin&utm_medium=Resource%20Screen&utm_campaign=Backend%20Help%20Page" target="_blank" rel="noopener"><?php esc_html_e( 'WordPress 101', 'lifterlms' ); ?></a></li>
				...
				<div class="llms-list">
					<h3><?php esc_html_e( 'Community Resources', 'lifterlms' ); ?></h3>
					<ul>
				...
				<div class="llms-list">
					<h3><?php esc_html_e( 'Third Party Recommendations', 'lifterlms' ); ?></h3>
					<ul>
						<li><a href="https://lifterlms.com/recommended-resources/#third?utm_source=LifterLMS%20Plugin&utm_medium=Resource%20Screen&utm_campaign=Backend%20Help%20Page" target="_blank" rel="noopener"><?php esc_html_e( 'LifterLMS Add-ons', 'lifterlms' ); ?></a></li>
						<li><a href="https://lifterlms.com/recommended-resources/#forms?utm_source=LifterLMS%20Plugin&utm_medium=Resource%20Screen&utm_campaign=Backend%20Help%20Page" target="_blank" rel="noopener"><?php esc_html_e( 'Form Plugins', 'lifterlms' ); ?></a></li>
						<li><a href="https://lifterlms.com/recommended-resources/#crm?utm_source=LifterLMS%20Plugin&utm_medium=Resource%20Screen&utm_campaign=Backend%20Help%20Page" target="_blank" rel="noopener"><?php esc_html_e( 'Email Marketing', 'lifterlms' ); ?></a></li>
						<li><a href="https://lifterlms.com/recommended-resources/#security?utm_source=LifterLMS%20Plugin&utm_medium=Resource%20Screen&utm_campaign=Backend%20Help%20Page" target="_blank" rel="noopener"><?php esc_html_e( 'Backups and Security', 'lifterlms' ); ?></a></li>
