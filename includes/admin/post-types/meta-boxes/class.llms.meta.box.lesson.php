			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'class'            => '',
						'group'            => 'input-cell',
						'id'               => $this->prefix . 'drip_unit_multiplier',
						'label'            => '&nbsp;',
						'type'             => 'select',
						'allow_null'       => false,
						'selected'         => 0 + $lesson->get( 'drip_unit_multiplier' ),
						'value'            => array(
							DAY_IN_SECONDS    => __( 'days', 'lifterlms' ),
							HOUR_IN_SECONDS   => __( 'hours', 'lifterlms' ),
							MINUTE_IN_SECONDS => __( 'minutes', 'lifterlms' ),
							1                 => __( 'seconds', 'lifterlms' ),
						),
					),
					array(
						'controller' => '#' . $this->prefix . 'drip_method',
