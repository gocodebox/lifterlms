		...
		$settings = array(
			...
			array(
				...
				'desc' 		=> __( 'Force secure checkout via SSL (https) on the checkout page(s).', 'lifterlms' ) .
							   '<br><span class="description">' . sprintf( __( 'Requires an SSL certificate. %sLearn More%s', 'lifterlms' ), '<a href="https://lifterlms.com/docs/ssl-and-https/#force-ssl" target="_blank">', '</a>' ) . '</span>',
