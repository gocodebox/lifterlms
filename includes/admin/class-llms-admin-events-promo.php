...
class LLMS_Admin_Events_Promo {
	...
	private function get_promo_html() {
		...
		$html .= '<a href="https://lifterlms.com/product/lifterlms-events/?utm_source=LifterLMS%20Plugin&utm_medium=Course%20Editor&utm_campaign=Events%20Promo" target="_blank" class="button button-primary">';
