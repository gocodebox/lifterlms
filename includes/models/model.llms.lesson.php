 ...
 * @since [version] Deprecated the `LLMS_Lesson::get_order()` method in favor of the `LLMS_Lesson::get( 'order' )` method.
...
class LLMS_Lesson extends LLMS_Post_Model {
	 ...
	 * @since 1.0.0
	 * @since 3.0.0 Unknown.
	 * @deprecated [version] Use `LLMS_Lesson::get( 'order' )`, via {@see LLMS_Post_Model::get()}, instead.
	 *
	 * @return int
	 */
	public function get_order() {

		llms_deprecated_function( __METHOD__, '[version]', __CLASS__ . '::get( \'order\' )' );
	 ...
	 * @since 1.0.0
	 * @since 3.0.0 Unknown.
	 * @deprecated [version] Use `LLMS_Lesson::get( 'parent_course' )`, via {@see LLMS_Post_Model::get()}, instead.
	 *
	 * @return int
	 */
	public function get_parent_course() {

		llms_deprecated_function( __METHOD__, '[version]', __CLASS__ . '::get( \'parent_course\' )' );
	 ...
	 * @deprecated [version] Use `LLMS_Lesson::set( 'parent_course', $course_id )`, via {@see LLMS_Post_Model::set()}, instead.
	 *
	...
	public function set_parent_course( $course_id ) {
		...
		llms_deprecated_function( __METHOD__, '[version]', __CLASS__ . '::set( \'parent_course\', $course_id )' );
	 ...
	 * @since [version] Replaced the call to the deprecated `LLMS_Section::get_order()` method with `LLMS_Section::get( 'order' )`.
	 *
	 * @param string $direction Direction of navigation. Accepts either "prev" or "next".
	 * @return false|int WP_Post ID of the sibling lesson or `false` if one doesn't exist.
	 */
